...
// const WhyVisitTanzania = ({ title, subtitle, cards = [] }) => {
//   return (
//     <section className="bg-white py-8 md:py-16 max-w-[1300px] mx-auto px-4 sm:px-6 md:px-10 lg:px-18 xl:px-0">
//       <h2 className="text-[24px] md:text-3xl capitalize font-bold text-center text-[#111] mb-3">
//         {title}
...
//       <p className="text-center text-[#444] text-[18px] mb-12">{subtitle}</p>
...
//               {card.subtitle && (
//                 <p className="text-[#d87029] font-medium mb-2">
//                   {card.subtitle}
//                 </p>
//               )}

//               <div
//                 className="text-[16px] text-[#333] leading-relaxed"
