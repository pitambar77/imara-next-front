...
//     if (section) {
//       const yOffset = -140; // offset to match sticky header height
//       const y =
...
//   return (
//     <div className=" hidden md:block bg-white pt-12 sticky top-[140px] z-9">
        ...
        <div className="flex flex-wrap items-center gap-8 py-4">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              onClick={() => handleTabClick(tab.id)}
              className={`text-[16px] uppercase font-semibold pb-2 transition ${
                activeTab === tab.id
                  ? "text-[#d87028] border-b-2 border-[#d87028]"
                  : "text-gray-700 hover:text-[#d87028]"
              }`}
