...
const BlogLandingForm = ({ editData, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editData) {
        res = await API.put(
          `/bloglanding/${editData._id}`,
          data,
        );
      } else {
        res = await API.post("/bloglanding", data);
      }

      alert("Saved Successfully!");
       router.push("/dashboard/blog-landing");
...
export default BlogLandingForm