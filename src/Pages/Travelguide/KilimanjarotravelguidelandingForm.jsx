...
const KilimanjarotravelguidelandingForm = ({ editData, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editData) {
        res = await API.put(
          `/kilimanjarotravelguidelanding/${editData._id}`,
          data,
        );
      } else {
        res = await API.post("/kilimanjarotravelguidelanding", data);
      }

      alert("Saved Successfully!");
       router.push("/dashboard/kilimanjaro-travelguide-landing");
...
export default KilimanjarotravelguidelandingForm