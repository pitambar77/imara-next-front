    ...
    <section className="relative h-[95vh] md:h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-center text-white px-4">
        ...
        <p className="max-w-4xl text-sm md:text-xl mb-4 md:mb-6 !font-avenir">
          Forfaits safari privés et sur mesure en Tanzanie, avec des guides
          experts, une organisation fluide et des expériences animalières
          inoubliables.
        </p>
        ...
        <div className="mt-4 w-full md:w-auto px-4 md:px-0">
          <button
            type="button"
            aria-label="Planifier mon safari en Tanzanie"
          ...
          >
            Planifier mon safari en Tanzanie
          </button>
        </div>
      </div>
    </section>
