...
const SafariLandingForm = ({ editData, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let res;
      if (editData) {
        res = await API.put(`/safarilanding/${editData._id}`, data);
      } else {
        res = await API.post("/safarilanding", data);
      }

      alert("Saved Successfully!");
      router.push("/dashboard/safari-landing");
...
export default SafariLandingForm;
