...
export default function BlogImaraForm({ id }) {
  ...
  async function handleSave(e) {
    ...
    try {
      ...
      if (id) {
        await axios.put(`${API_BASE}/blogimara/${id}`, form, {
          headers: { "Content-Type": "multipart/form-data" },
        });
        setSuccess("Blog updated ✓");
      } else {
        await axios.post(`${API_BASE}/blogimara`, form, {
          headers: { "Content-Type": "multipart/form-data" },
        });
      ...
      setSubTitle("");
      setSlug("");
      router.push("/dashboard/blogimara");
    } catch (e) {
      console.error(e);
