...
const TailormadeToursPageForm = ({ editData, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editData) {
        res = await API.put(
          `/enquirytours/${editData._id}`,
          data,
        );
      } else {
        res = await API.post("/enquirytours", data);
      }

      alert("Saved Successfully!");
       router.push("/dashboard/tailormade-tours");
...
export default TailormadeToursPageForm