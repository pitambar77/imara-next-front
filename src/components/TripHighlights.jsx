      ...
      <div className="max-w-[1300px] mx-auto px-4 sm:px-6 md:px-10 lg:px-18 xl:px-0">
        ...
        <div className="relative flex items-center justify-center mb-8 md:mb-12">
          ...
          <div className=" hidden md:block absolute right-0 flex items-center space-x-3">
            <button
              ref={swiperNavPrevRef}
              className="swiper-button-prev- cursor-pointer hover:text-[#d87029] hover:border-[#d87029]/40 bg-white border border-gray-300 text-gray-800 rounded-full p-3 hover:bg-gray-100 shadow-sm transition"
            >
              <MoveLeft size={18} />
            </button>
            ...
            <button
              ref={swiperNavNextRef}
              className="swiper-button-next-custom cursor-pointer hover:text-[#d87029] hover:border-[#d87029]/40 bg-white border border-gray-300 text-gray-800 rounded-full p-3 hover:bg-gray-100 shadow-sm transition"
            >
              <MoveRight size={18} />
            </button>
          </div>
...
const CustomTripHighlightSlider = ({
  data,
  expandedCard,
  setExpandedCard,
  formatTitle,
